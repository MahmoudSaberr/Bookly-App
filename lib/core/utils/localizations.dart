...
class MyLocalizations{
  ...
  Future<void> loadJsonFile() async {
    ...
    String jsonSource = await rootBundle.loadString("assets/translations/${locale!.languageCode}.json");    // throw the locale's value which be taken from constructor, I will get languageCode, will be one of ar or en
...
class _MyLocalizationsDelegates extends LocalizationsDelegate<MyLocalizations>{
  ...
  bool isSupported(Locale locale) {
    ...
    return ["en","ar"].contains(locale.languageCode) ;    // if languageCode equal one of ar , en return true else false
  }
